...
```{r, echo = F, out.width = "100%", fig.height = 6}
library(knitr)
library(png)
img.path = "files/marsh_bino.jpg"
...
### Integrated population models and full annual cycle dynamics   
...
myimages<-c("files/prow_male.jpg", "files/prow_nestling_banded.jpg")
