...
Most of the analyses for my PhD use mark-resight data of shorebirds marked with individually unique, field-readble flags like the one on the left. Many field house conversations about how easily flag reading errors could occur in the field or during data entry, we decided to investigate how frequently they occurred in our data and what effect that might have on survival estimates. We found that when misreads occur, they can cause apparent negative trends in survival even when in reality survival has been constant over time. The paper on that work is out this month in The Condor, so stay tuned! 
